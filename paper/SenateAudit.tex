...
A risk limit of 1\% would require hand inspection of roughtly 24,000 ballots, assuming no errors were found.\footnote{These numbers are derived from tools at {\url{https://www.stat.berkeley.edu/~stark/Java/Html/auditTools.htm}} } 
...
\begin{itemize}
	...
	\item for ``negative'' audits, a sample that found 3 or more errors out of 1000 ballots would give a 99\% confidence bound on the error rate (being big enough),
